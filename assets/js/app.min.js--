...
+function(a) {
    ...
    g.prototype.fix = function() {
        ...
        if (a("body").hasClass(f.fixed))
            ...
            var h;
            d >= g ? (a(e.contentWrapper).css("min-height", d - c),
            h = d - c) : (a(e.contentWrapper).css("min-height", g),
            h = g);
...
function(a) {
    ...
    h.prototype.expand = function() {
        ...
        a(this.element).find(e.body + ", " + e.footer).slideDown(this.options.animationSpeed, function() {
    ...
    h.prototype.collapse = function() {
        ...
        a(this.element).find(e.body + ", " + e.footer).slideUp(this.options.animationSpeed, function() {
