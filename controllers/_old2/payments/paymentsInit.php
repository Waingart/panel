...
HOOK::add_action('modal_content', function(){
    return '<iframe  style="width:390px; height:100%; min-height:700px; border:none; display:block; margin: auto" src="/payments/go_pay/"></iframe>'; //s
});
