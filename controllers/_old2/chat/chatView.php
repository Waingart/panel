...
$intpl = $tpl->content(__DIR__.'/tpl/chat.editor.html');
...
Helper::Add_js('/assets/vendor/plugins/slimScroll/jquery.slimscroll.min.js', 'users', 'Slimscroll');
Helper::Add_js("/controllers/chat/tpl/chat.".$_SESSION["access_level"].".editor.js", 'users', 'users editor');
