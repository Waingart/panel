...
$intpl = $tpl->content(__DIR__.'/tpl/task1.editor.html');
    $intpl->modal_windows(__DIR__."/tpl/testModal.modal.html");
...
Helper::Add_js("/controllers/task1/tpl/task1.editor.js", 'task1', 'users editor');
