...
$sber = new SberPay($user, $amount);

if($_GET['rbspayment']=='result'){
	$sber->callb();
}else{
	$sber->generate_form(31337, 370.50);
}
...
class SberPay {
        ...
        public function generate_form($order_id, $amount)
        {
            ...
            $args = array(
                ...
                'amount' => $amount,
                'returnUrl' => 'https://manager.abelar.ru/module-test/sber/index.php?rbspayment=result&order_id=' . $order_id . $extra_url_param,
