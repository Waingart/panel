...
$grid_config = array(
	...
	'dbtable' => 'payments',
	'id_field' => 'pay_id',
	'visible_fields' => array('pay_date', 'amount', 'pay_descr', 'target', 'inpay'),
	'title_fields' => array('pay_date'=>'Дата', 'amount'=>'Сумма', 'pay_descr'=>'Контрагент', 'target'=>'Назначение', 'inpay'=>'Направление'),
	...
	'tech_fields' => array('pay_id'),
	'actions' => array('change_target'),
	'operations' => array(
	        'change_target' => array('bticon'=>'clock', 'title'=>'Указать категорию платежа', 'url'=>'', 'modal_id'=>'change_targetModal'),
	),
	'modals' => array(
	    'change_targetModal' => array('title'=>'Указать категорию платежа', 'type'=>0, 'content'=>'change_target.modal.html')
	)
);
